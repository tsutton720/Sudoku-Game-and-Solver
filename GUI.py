...
class GUI:
    ...
    def __init__(self):
        ...
        self.answerBoard = Sudoku.makeAnswer()
        self.OGBoard = Sudoku.makeGameBoard(self.answerBoard)
    ...
    def drawGrid(self, display):
        ...
        text = font.render("Sudoku", 1, (0, 162, 199))
...
def findCube(XY, board):
    ...
    if (
            board.pad < mouseX < board.width - board.pad and board.pad < mouseY < board.height - board.pad):
